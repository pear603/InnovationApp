...
export const TransactionService = {
    ...
    // -------------------------
    getWalletInfo: async (walletId, walletType) => {
        ...
        if (wallet.WalletType.toLowerCase() === 'both' || walletType.toLowerCase() === 'both') {
            ...
            walletData.originalBudget = Number(bothWallet?.Budget || 0);
            walletData.monthlyGoal = Number(bothWallet?.Goal || 0);
        ...
        if (walletType.toLowerCase() === 'expense') {
            ...
            walletData.originalBudget = Number(expenseWallet?.Budget || 0);
        ...
        if (walletType.toLowerCase() === 'income') {
            ...
            walletData.monthlyGoal = Number(incomeWallet?.Goal || 0);
    ...
    calcDailyBudget: (newRemainingBudget, daysLeft) => daysLeft > 0 ? newRemainingBudget / daysLeft : newRemainingBudget
};
